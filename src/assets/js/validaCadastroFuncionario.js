...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const campos = [
        ...
        { input: document.getElementById("CRP"), alerta: document.getElementById("alertaCRP") },
        { input: document.getElementById("CRN"), alerta: document.getElementById("alertaCRN") },
        { input: document.getElementById("CRM"), alerta: document.getElementById("alertaCRM") },
